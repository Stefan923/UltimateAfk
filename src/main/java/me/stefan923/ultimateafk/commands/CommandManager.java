...
public class CommandManager implements CommandExecutor, MessageUtils {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        commandSender.sendMessage(formatAll("&8[&3UltimateAfk&8] &cThe command you entered does not exist or is spelt incorrectly."));
        return true;
    }
    ...
    private void processRequirements(AbstractCommand command, CommandSender sender, String[] strings) {
        ...
        sender.sendMessage(formatAll("&8[&3UltimateAfk&8] &cYou have no permission!"));
    }
