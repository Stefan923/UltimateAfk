...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(UltimateAfk instance, CommandSender sender, String... args) throws MissingPermissionException;

    protected abstract List<String> onTab(UltimateAfk instance, CommandSender sender, String... args);
